                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-center py-2 px-3 rounded-md text-sm font-medium"
                    >
                      Live Demo
                    </a>
                  </div>
